-- ============================================================
-- SEED: 28 orçamentos de teste para o gc-dev
-- ============================================================
-- Roda no SQL Editor do Supabase Studio (projeto gc-dev).
-- Insere 28 orçamentos com status, datas e valores variados
-- pra testar paginação (>20), busca, filtros e a aba de detalhes.
--
-- Todos vêm marcados com "[SEED-TESTE]" em observacao pra facilitar
-- limpeza depois. Veja o bloco de cleanup no final do arquivo.
-- ============================================================

with empresa as (
  -- Se você tiver mais de uma empresa, troca esse select por:
  --   select '<uuid-da-empresa>'::uuid as id
  select id from empresas order by created_at limit 1
)
insert into orcamentos (
  empresa_id, numero, data_solicitacao,
...
select
  ...
  v.cliente_nome, v.cliente_contato, v.cliente_telefone, v.cliente_email, v.cliente_cidade,
...
from (values
  -- ----- PENDENTES (8) -----
  ('ORC-2026-001', '2026-05-08', 'Construtora Alvorada LTDA', 'Marcelo Tavares', '(85) 99812-3344', 'marcelo@alvorada.com.br', 'Fortaleza',
  ...
  ('ORC-2026-002', '2026-05-05', 'Edifício Costa Sol — Síndico', 'Patrícia Lima', '(85) 98765-1122', 'sindico.costasol@gmail.com', 'Fortaleza',
  ...
  ('ORC-2026-003', '2026-05-02', 'Hospital Vida Plena', 'Engª. Fernanda Cruz', '(85) 99100-2233', 'compras@vidaplena.com.br', 'Caucaia',
   'Pergolado em aço para área de espera externa', null, 42000.00, '20 dias',
   'pendente', null, null, null, null, 'Ana Beatriz', '[SEED-TESTE]'),

  (null, '2026-04-28', 'Mercado Bom Preço', 'Sr. Antônio', '(85) 99654-7788', null, 'Maracanaú',
   'Estrutura para letreiro frontal', null, 8500.00, '10 dias',
   'pendente', null, null, null, null, 'João Souza', '[SEED-TESTE] sem número'),

  ('ORC-2026-005', '2026-04-22', 'Residencial Atlântico — Construtora Sol', 'Diego Andrade', '(85) 98877-4455', 'diego@solconstr.com.br', 'Eusébio',
   'Guarda-corpo em vidro e aço inox para varandas', '32 unidades, instalação por conta', 67000.00, '30 dias',
   'pendente', null, null, null, null, 'Ana Beatriz', '[SEED-TESTE]'),

  ('ORC-2026-006', '2026-04-15', 'Indústria Cearense de Alimentos', 'Engº. Roberto Pinto', '(85) 99221-3300', 'rpinto@icalimentos.com.br', 'Maracanaú',
   'Mezanino metálico para estoque', null, 95000.00, '40 dias',
   'pendente', null, null, null, null, 'João Souza', '[SEED-TESTE]'),

  ('ORC-2026-007', '2026-04-10', 'Colégio Aprender Mais', 'Coord. Juliana Reis', null, 'juliana@aprendermais.edu.br', 'Fortaleza',
   'Coberta para quadra poliesportiva', 'Estrutura tubular, sem fechamento lateral', 215000.00, '50 dias',
   'pendente', null, null, null, null, 'Ana Beatriz', '[SEED-TESTE]'),

  (null, '2026-04-05', 'Restaurante Maré Alta', 'Carlos Mendes', '(85) 99300-1144', 'carlosmendes@email.com', 'Aquiraz',
   'Pergolado deck área externa', null, 28000.00, '15 dias',
   'pendente', null, null, null, null, 'João Souza', '[SEED-TESTE]'),

  -- ----- EM ANÁLISE (4) -----
  ('ORC-2026-009', '2026-04-02', 'Banco Regional Nordeste', 'Engª. Mariana Souto', '(85) 98800-2211', 'mariana.souto@bnordeste.com.br', 'Fortaleza',
  ...
  ('ORC-2026-010', '2026-03-28', 'Cond. Empresarial Beira-Mar', 'Síndico João Vasco', '(85) 99711-3322', 'joao.vasco@beirammar.com.br', 'Fortaleza',
  ...
  ('ORC-2026-011', '2026-03-20', 'Auto Posto Verde', 'Roberto Mello', '(85) 99544-8899', 'rmello@autopostoverde.com.br', 'Pacatuba',
   'Estrutura para nova bomba de combustível', null, 56000.00, '25 dias',
   'analise', null, null, null, null, 'João Souza', '[SEED-TESTE]'),

  ('ORC-2026-012', '2026-03-12', 'Clínica Saúde Total', 'Dr. Henrique Aragão', '(85) 98765-9911', 'contato@saudetotal.com.br', 'Fortaleza',
  ...
  -- ----- ENVIADOS (4) -----
  ('ORC-2026-013', '2026-03-05', 'Shopping Aldeia Mall', 'Engº. Paulo Vasconcelos', '(85) 99100-7766', 'paulo.v@aldeiamall.com.br', 'Fortaleza',
  ...
  ('ORC-2026-014', '2026-02-28', 'Construtora Horizonte', 'Engª. Camila Brito', '(85) 99877-2244', 'camila.brito@horizonte.eng.br', 'Caucaia',
  ...
  ('ORC-2026-015', '2026-02-15', 'Indústria Têxtil Cearense', 'Engº. Marcos Alencar', '(85) 99221-1188', 'marcos@texcear.com.br', 'Maracanaú',
  ...
  ('ORC-2026-016', '2026-02-08', 'Faculdade Norte Brasileira', 'Pró-reitor adm.', null, 'compras@fnb.edu.br', 'Fortaleza',
   'Pergolado de convivência campus', null, 92000.00, '40 dias',
   'enviado', '2026-03-20', null, null, null, 'Ana Beatriz', '[SEED-TESTE]'),

  -- ----- APROVADOS (5) -----
  ('ORC-2026-017', '2026-02-01', 'Cond. Residencial Solar', 'Síndico Eduardo Cavalcante', '(85) 99300-7766', 'sindico.solar@gmail.com', 'Fortaleza',
  ...
  ('ORC-2026-018', '2026-01-22', 'Hotel Brisa do Mar', 'Gerente Renata Lima', '(85) 98800-6655', 'rlima@brisadomar.com.br', 'Aquiraz',
   'Estrutura para deck piscina', null, 88000.00, '35 dias',
   'aprovado', '2026-02-10', '2026-03-01', null, null, 'Ana Beatriz', '[SEED-TESTE]'),

  ('ORC-2026-019', '2026-01-15', 'Igreja Matriz Centro', 'Pe. Francisco Lima', '(85) 99654-2211', null, 'Sobral',
   'Cobertura em treliça para pátio', null, 156000.00, '60 dias',
   'aprovado', '2026-02-01', '2026-02-25', null, null, 'João Souza', '[SEED-TESTE]'),

  ('ORC-2026-020', '2026-01-10', 'Posto Modelo Sul', 'Sr. Lúcio Andrade', '(85) 99100-5544', 'lucio@postomodelo.com.br', 'Eusébio',
   'Troca de cobertura completa', null, 195000.00, '50 dias',
   'aprovado', '2026-01-28', '2026-02-18', null, null, 'Ana Beatriz', '[SEED-TESTE]'),

  (null, '2026-01-05', 'Padaria Pão Quentinho', 'Sra. Helena Souza', '(85) 99877-3322', null, 'Fortaleza',
  ...
  ('ORC-2026-022', '2025-12-28', 'Construtora Aurora', 'Engª. Beatriz Sales', '(85) 98765-4455', 'bia@aurora.eng.br', 'Maracanaú',
  ...
  ('ORC-2026-023', '2025-12-15', 'Mercadinho do Zé', 'Sr. José Maria', '(85) 99300-2200', null, 'Caucaia',
  ...
  ('ORC-2026-024', '2025-12-05', 'Loja Móveis Lar Doce', 'Carla Andrade', '(85) 99544-1100', 'carla@lardoce.com.br', 'Fortaleza',
  ...
  ('ORC-2026-025', '2025-11-28', 'Distribuidora Centro-Norte', 'Engº. Felipe Cardoso', '(85) 98800-9988', 'fcardoso@dcn.com.br', 'Maracanaú',
  ...
  ('ORC-2026-026', '2025-11-15', 'Cond. Empresarial Iracema', 'Síndico Ricardo Veloso', '(85) 99221-7788', 'ricardo@iracema.com.br', 'Fortaleza',
  ...
  -- ----- EXPIRADOS (2) -----
  ('ORC-2026-027', '2025-11-08', 'Restaurante Sabor do Mar', 'Sr. Anderson Pinto', '(85) 99100-8855', 'anderson@sabordomar.com.br', 'Aquiraz',
  ...
  ('ORC-2026-028', '2025-11-01', 'Auto Center Veloso', 'Sr. Pedro Veloso', '(85) 99877-4400', null, 'Pacatuba',
   'Cobertura para área de lavagem', null, 38000.00, '20 dias',
   'expirado', '2025-11-20', null, null, null, 'João Souza', '[SEED-TESTE]')
) as v(
  numero, data_solicitacao,
  cliente_nome, cliente_contato, cliente_telefone, cliente_email, cliente_cidade,
  descricao, escopo_resumo, valor_estimado, prazo_estimado,
  status, data_envio, data_decisao,
  motivo_rejeicao, detalhe_rejeicao,
...
on conflict (empresa_id, numero) where numero is not null do nothing;
